...
//----------------------------UPLOADFILES------------------------------------
    ...
    var locale = {
        ...
        en: {
            ...
            clear: '清除',
            drag: '拖拽',
            sizeError: '$1 超过了最大允许上传大小 $2',// $1=file name ,$2=max ie( example.jpg has has exceed the size limit of 2mb)
            extError: '文件类型 $1 不被支持',//$1=file extension ie(exe files are not supported)
            someErrorsOccurred: '发生了错误'
        },
        gr: {
            success: 'Επιτυχία',
